...
require_once "../includes/criar-classe-admin.php"; 
...
if (isset($_POST['deletar-anuncio-admin'])) {
    ...
    $motivo = isset($_POST['motivo']) ? trim($_POST['motivo']) : 'Violação dos termos de uso.';
    ...
    $motivoEscapado = $conexao->escape_string($motivo);
    $conexao->query("UPDATE `{$banco->anuncio}` SET deletado = 1, motivo = '{$motivoEscapado}' WHERE id = $id_anuncio_del");
...
<head>
    ...
    <link rel="stylesheet" href="../css/admin/painel-admin.css">
    <!--JAVASCRIPT-->
        ...
        <div id="tela-admin" class="tela collapse">
            ...
            <section class="cards-estatisticas">
                <div class="card-stat">
                    <h3>
                        <?php 
                        $contAnuncios = $conexao->query("SELECT COUNT(*) FROM " . $banco->anuncio . " WHERE motivo IS NULL");
                        ...
                        if ($resultado_feedbacks && $resultado_feedbacks->num_rows > 0) {
                            while ($f = $resultado_feedbacks->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td class='coluna-previa-fb'>$previaTexto</td> 
                                    <td>
                            ...
                            echo "<tr><td colspan='4' class='tabela-vazia-txt'>Nenhum feedback registrado.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
