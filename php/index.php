...
require_once "../includes/criar-classe-aluno.php";
require_once "../includes/criar-classe-avaliacao.php";
require_once "../includes/criar-classe-denuncia.php";
require_once "../includes/criar-classe-feedback.php";
...
if (isset($_POST['deletar_id_anuncio'])) {
    ...
    $id_user = intval($_SESSION['id_aluno']); 
...
if (isset($_POST['excluir-anuncio-definitivo-aluno'])) {
    $id_anuncio_del = intval($_POST['id_anuncio_aluno']);
    $id_user = intval($_SESSION['id_aluno']); 
    $sql_delete = "DELETE FROM " . $banco->anuncio . " WHERE id = $id_anuncio_del AND id_aluno = $id_user";
    header('Content-Type: application/json');
    if ($conexao->query($sql_delete)) {
        echo json_encode(['sucesso' => true, 'id' => $id_anuncio_del]);
        exit();
    } else {
...
<head>
    ...
    <!--CSS PRINCIPAL-->
    <link rel="stylesheet" href="../css/geral/main.css">
    <link rel="stylesheet" href="../css/geral/pesquisar.css">
    <link rel="stylesheet" href="../css/geral/listagem-anuncios.css">
    <link rel="stylesheet" href="../css/geral/extras.css">
    <link rel="stylesheet" href="../css/geral/detalhes.css">

    <!--CSS ALUNO-->
    <link rel="stylesheet" href="../css/aluno/meus-anuncios.css">
    <link rel="stylesheet" href="../css/aluno/novo-anuncio.css">
    <link rel="stylesheet" href="../css/aluno/favoritos.css">
    <link rel="stylesheet" href="../css/aluno/perfil.css">
    <link rel="stylesheet" href="../css/aluno/feedback.css">

    <!--JAVASCRIPT-->
    <script src="../js/troca-de-tela.js"></script>
    <script src="../js/favoritos.js"></script>
    <script src="../js/gerenciar-anuncios.js"></script>
    <script src="../js/ver-detalhes.js"></script>
    ...
    <main class="blocoCentral">
        ...
        <div id="tela-pesquisa" class="tela collapse">
            ...
            <div class="grid-anuncios resultados-grid-wrapper">
                <?php $anuncios->listarAnunciosAtivos($conexao, $banco->anuncio, $_SESSION['id_aluno'], $_GET); ?>
            </div>
        </div>
            ...
            <form class="form-anuncio" method="post" action="index.php" enctype="multipart/form-data">
                ...
                <section class="sessao-form">
                    ...
                    <div class="fila-campos">
                        ...
                        <div class="campo" id="container-status-anuncio" style="display: none;">
        ...
        <div id="tela-favoritos" class="tela collapse">
            ...
            <div class="grid-anuncios">
                <?php $anuncios->listarFavoritosDoAluno($conexao, $banco->anuncio, $_SESSION['id_aluno']); ?>
            </div>
        </div>
        ...
        <div id="tela-perfil" class="tela collapse">
            ...
            <section class="secao-perfil">
                <form method="POST" action="" enctype="multipart/form-data" target="retorno_foto_segredo" id="form-foto-perfil">
                    <div class="perfil-topo">
                        <div class="avatar-edit perfil-avatar-container">
                            <?php 
                            $caminhoFisicoFoto = __DIR__ . '/../' . $alunos->foto_perfil;
                            if (!empty($alunos->foto_perfil) && file_exists($caminhoFisicoFoto)): ?>
    ...
    <aside class="blocoDireito">
        <div class="perfil-resumo">
            ...
            <div class="avatar-grande perfil-aside-avatar-box">
                <?php 
                $caminhoFisicoAside = __DIR__ . '/../' . $alunos->foto_perfil;
                if (!empty($alunos->foto_perfil) && file_exists($caminhoFisicoAside)): ?>
            ...
            <p class="avaliacao">Média de Avaliações: <span class="media-perfil-aside"><?php echo $media_formatada; ?></span></p>
        </div>
